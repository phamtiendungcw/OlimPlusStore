...
{
    public class GetAllDeliveryInformationQueryHandler : IRequestHandler<GetAllDeliveryInformationQuery, List<DeliveryInformationDto>>
    {
        ...
        public async Task<List<DeliveryInformationDto>> Handle(GetAllDeliveryInformationQuery request, CancellationToken cancellationToken)
        {
